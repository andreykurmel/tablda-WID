...
function drawAISCmember(XD, approach, app_p1, app_p2, app_p3, dbSRC, Shape, SizeType, SizeUnit, Size1, Size2, material, rot_x2stdy, shrk_pct, mode, shrink_p, GridSize2D, sectionsInfo) {
    ...
    if (XD == "3D" || XD == "23D") {
        ...
        mesh = new draw_3D(Shape, approach, app_p1, app_p2, app_p3, nodes, nodes_hole, nodes_ctrl, material, mode, shrink_p);
...
function draw_3D(Shape, approach, app_p1, app_p2, app_p3, nodes, nodes_hole, nodes_ctrl, material, mode, shrink_p) {
    var newNodes = {};
