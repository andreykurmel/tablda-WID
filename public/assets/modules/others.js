...
$(document).ready(function () {
    ...
    myLayout = $('body').layout({
        ...
        , east__size: .393
        , east__minSize: 200
        // , east__maxSize: .393 // 39.3% of layout width
    ...
    myLayout
        ...
        .bindButton('#openEastButton', 'toggle', 'east')
    ...
    var openEastButton = document.createElement('div');
    openEastButton.id = 'openEastButton';

    $(openEastButton).insertBefore($('.ui-layout-toggler-east'));

    $("#openEastButton").click(function () {
        if(fullScreen = !fullScreen) myLayout.sizePane("east", "100%");
        else myLayout.sizePane("east", .393);
    });
