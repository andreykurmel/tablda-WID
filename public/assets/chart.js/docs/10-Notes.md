...
Browser support for the canvas element is available in all modern & major mobile browsers <a href="https://caniuse.com/#feat=canvas" target="_blank">(http://caniuse.com/#feat=canvas)</a>.
