...
class da_eng {
    ...
    function calc($product_data){
        ...
        for ($iface = 0; $iface < sizeof($da['faces']); $iface++) {
            $da['faces'][$iface]['angle_btw'] = unitConversion($da['faces'][$iface]['angle_btw'], $unit2show->angle_btw);
            
            $da['faces'][$iface]['azimuth'] = unitConversion($da['faces'][$iface]['azimuth'], $unit2show->frt_azm);
            $da['faces'][$iface]['P_A_A_A'] = unitConversion($da['faces'][$iface]['P_A_A_A']  , $unit2show->p_a);
            $da['faces'][$iface]['EPA_A']   = unitConversion($da['faces'][$iface]['EPA_A']  , $unit2show->epa_a);
        }                   
        ...
        // if( !empty($da['quantity']) && $da['quantity']>1 ){
        //     $da['epa_a']['value'] = $da['epa_a']['value']*$da['quantity'];
        //     $da['dwf']['value']   = $da['dwf']['value']*$da['quantity'];
        // }
        ...
        'quantity'       => isset($da['quantity']) ?   $da['quantity'] : 1        
        ];
