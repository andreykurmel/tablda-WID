<div id="faces-tab" class="tab-pane">
    ...
    <div ng-show="activeList">
        ...
        <h5 class="titleFaces">Wind Exposure Faces of a DA (not site depdendent)</h5>  
        ...
        <table id="wlda-loading-table-faces" class="table table-striped table-bordered table-for-jack" >
            ...
            <tr>
                ...
                <th width="80px" style="text-align: center;">Angle btw Face Norm - Wind</th>                
                ...
                <th width="50px" style="text-align: center;">(EPA)<sub>Ai</sub></th>
            ...
            <tr ng-repeat="row in activeList.faces">
                ...
                <td width="" class="loading-inner-table-td"><input class="form-control" ng-model="row.angle_btw" ng-readonly="row.display == 'false'" ng-change="row.change = true;"></td>
