...
require_once("./../general/calcs/ALL/code/TIA/222/G/g_calc.php");
...
class wid {
    function calc_pro_epa($data) {
        ...
        // or $angles = [0, 15, 30, 45, 60, 75, 90, 105, 120, 135, 150, 165, 180, 195, 210, 225, 240, 255, 270, 285, 300, 315, 330, 345, 360];
